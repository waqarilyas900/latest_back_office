                ...
                <div class="col-span-12">
                    <div class="card border-0 overflow-hidden">
                        ...
                        <div class="card-header flex items-center justify-between">
                            <h6 class="card-title mb-0 text-lg">Product Category</h6>
                            <input 
                                type="text" 
    ...
    <div>
        ...
        @if ($showForm)
            <div class="flex justify-center items-center min-h-[60vh] bg-gray-50">
                <form wire:submit.prevent="save" class="bg-white shadow-lg rounded-xl p-8 w-full">
                    ...
                    <div class="mb-5">
                        ...
                        <input id="categoryName" name="categoryName" type="text" wire:model.defer="name" placeholder="Enter category name"
