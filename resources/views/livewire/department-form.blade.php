                ...
                <div class="col-span-12">
                    <div class="card border-0 overflow-hidden">
                        ...
                        <div class="card-header flex items-center justify-between">
                            <h6 class="card-title mb-0 text-lg">Departments</h6>
                            <input 
                                type="text" 
                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                ...
                                {{-- Pagination --}}
                                <div>
                                    {{ $departments->onEachSide(1)->links('vendor.pagination.tailwind') }}
                                </div>
                            </div>
            ...
            <div class="flex justify-center items-center min-h-[60vh] bg-gray-50">
                <form wire:submit.prevent="save" class="bg-white shadow-lg rounded-xl p-8 w-full max-w-xl">
                    ...
                    <div class="mb-5">
                        ...
                        <input id="departmentName" name="departmentName" type="text" wire:model.defer="name" placeholder="Enter department name"
