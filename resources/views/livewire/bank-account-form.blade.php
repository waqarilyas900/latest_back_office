                ...
                <div class="col-span-12">
                    <div class="card border-0 overflow-hidden">
                        ...
                        <div class="card-header flex items-center justify-between">
                            <h6 class="card-title mb-0 text-lg">Account</h6>
                            <input 
                                type="text" 
                                wire:model.live="search" 
                                placeholder="Search account account..." 
                        ...
                        {{-- Pagination --}}
                        <div>
                            {{ $accounts->onEachSide(1)->links('vendor.pagination.tailwind') }}
                        </div>
                    </div>
        ...
        @if ($showForm)
            <div class="flex justify-center items-center min-h-[60vh] bg-gray-50">
                <form wire:submit.prevent="save" class="bg-white shadow-lg rounded-xl p-8 w-full max-w-xl">
                    <h2 class="text-2xl font-bold mb-6 text-gray-800">Add Account</h2>
                    <div class="mb-5">
                        <label for="accountName" class="block text-sm font-medium text-gray-700 mb-2">Account Name</label>
                        <input id="accountName" name="accountName" type="text" wire:model.defer="account_name" placeholder="Enter account name"
