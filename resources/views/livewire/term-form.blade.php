<div class="">
                ...
                <div class="col-span-12">
                    <div class="card border-0 overflow-hidden">
                        ...
                        <div class="card-header flex items-center justify-between">
                            <h6 class="card-title mb-0 text-lg">Terms</h6>
                            <input 
                                type="text" 
    ...
    <div class="text-sm text-gray-600">
        Showing 
        <span class="font-medium">{{ $terms->firstItem() }}</span> 
        to 
        <span class="font-medium">{{ $terms->lastItem() }}</span> 
        of 
            ...
            <div class="col-span-12">
                <div class="card border-0">
                    <div class="card-header">
                        <h5 class="text-lg font-semibold mb-0">Add term</h5>
                    </div>
                    <div class="card-body">
                        <form wire:submit.prevent="save" class="grid grid-cols-12 gap-4">
                            ...
                            <div class="md:col-span-6 col-span-12">
                                <label for="termName" class="block text-sm font-medium text-gray-700 mb-2">Term Name</label>
                                <input id="termName" name="termName" type="text" wire:model.defer="name" placeholder="Enter term name"
