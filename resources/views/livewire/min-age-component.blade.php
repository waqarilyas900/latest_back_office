                ...
                <div class="col-span-12">
                    <div class="card border-0 overflow-hidden">
                        ...
                        <div class="card-header flex items-center justify-between">
                            <h6 class="card-title mb-0 text-lg">Min Age</h6>
                            <input 
                                type="text" 
                                wire:model.live="search" 
                                placeholder="Search min ages..." 
                        ...
                        <div class="card-body">
                            ...
                            <table id="ages-table" 
                                ...
                                <thead class="bg-neutral-100 dark:bg-neutral-700">
                                    ...
                                    <tbody>
                                        @forelse ($ages as $index => $department)
                            ...
                            <div class="mt-4 flex justify-between items-center">
                                ...
                                <div class="text-sm text-gray-600">
                                    Showing 
                                    <span class="font-medium">{{ $ages->firstItem() }}</span> 
                                    to 
                                    <span class="font-medium">{{ $ages->lastItem() }}</span> 
                                    of 
                                    <span class="font-medium">{{ $ages->total() }}</span> 
                                    entries
                                </div>

                                {{-- Pagination --}}
                                <div>
                                    {{ $ages->onEachSide(1)->links('vendor.pagination.tailwind') }}
                                </div>
                            </div>
        ...
        @if ($showForm)
            <div class="flex justify-center items-center min-h-[60vh] bg-gray-50">
                <form wire:submit.prevent="save" class="bg-white shadow-lg rounded-xl p-8 w-full max-w-xl">
                    <h2 class="text-2xl font-bold mb-6 text-gray-800">Add Min Age</h2>
                    <div class="mb-5">
                        <label for="minAgeName" class="block text-sm font-medium text-gray-700 mb-2">Min Age</label>
                        <input id="minAgeName" name="minAgeName" type="text" wire:model.defer="name" placeholder="Enter min age name"
