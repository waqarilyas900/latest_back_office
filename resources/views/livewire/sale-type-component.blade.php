<div class="">
                ...
                <div class="col-span-12">
                    <div class="card border-0 overflow-hidden">
                        ...
                        <div class="card-header flex items-center justify-between">
                            <h6 class="card-title mb-0 text-lg">Sale Type</h6>
                            <input 
                                type="text" 
    ...
    {{-- Pagination --}}
    <div>
        {{ $sales->onEachSide(1)->links('vendor.pagination.tailwind') }}
    </div>
</div>
            ...
            <div class="col-span-12">
                <div class="card border-0">
                    <div class="card-header">
                        <h5 class="text-lg font-semibold mb-0">Add sale</h5>
                    </div>
                    <div class="card-body">
                        <form wire:submit.prevent="save" class="grid grid-cols-12 gap-4">
                            ...
                            <div class="md:col-span-6 col-span-12">
                                ...
                                <input id="saleName" name="saleName" type="text" wire:model.defer="name" placeholder="Enter sale name"
