                ...
                <div class="col-span-12">
                    <div class="card border-0 overflow-hidden">
                        ...
                        <div class="card-header flex items-center justify-between">
                            <h6 class="card-title mb-0 text-lg">Locations</h6>
                            <input 
                                type="text" 
        ...
        @if ($showForm)
            <div class="flex justify-center items-center min-h-[60vh] bg-gray-50">
                <form wire:submit.prevent="save" class="bg-white shadow-lg rounded-xl p-8 w-full max-w-xl">
                    <h2 class="text-2xl font-bold mb-6 text-gray-800">Add Location</h2>
                    <div class="mb-5">
                        <label for="locationName" class="block text-sm font-medium text-gray-700 mb-2">Location Name</label>
                        <input id="locationName" name="locationName" type="text" wire:model.defer="name" placeholder="Enter location name"
                    ...
                    <div class="mb-5">
                        ...
                        <input id="locationAddress" name="locationAddress" type="text" wire:model.defer="address" placeholder="Enter location name"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent bg-gray-50 text-gray-800" />
                        @error('name') 
                            <small class="text-red-500">{{ $message }}</small> 
                        @enderror
