<div class="">
                ...
                <div class="col-span-12">
                    <div class="card border-0 overflow-hidden">
                        ...
                        <div class="card-header flex items-center justify-between">
                            <h6 class="card-title mb-0 text-lg">Sizes</h6>
                            <input 
                                type="text" 
    ...
    <div class="text-sm text-gray-600">
        Showing 
        <span class="font-medium">{{ $sizes->firstItem() }}</span> 
        to 
        <span class="font-medium">{{ $sizes->lastItem() }}</span> 
        of 
        <span class="font-medium">{{ $sizes->total() }}</span> 
        entries
    </div>

    {{-- Pagination --}}
    <div>
        {{ $sizes->onEachSide(1)->links('vendor.pagination.tailwind') }}
    </div>
</div>
            ...
            <div class="col-span-12">
                <div class="card border-0">
                    <div class="card-header">
                        <h5 class="text-lg font-semibold mb-0">Add size</h5>
                    </div>
                    <div class="card-body">
                        <form wire:submit.prevent="save" class="grid grid-cols-12 gap-4">
                            ...
                            <div class="md:col-span-6 col-span-12">
                                ...
                                <input id="sizeName" name="sizeName" type="text" wire:model.defer="name" placeholder="Enter size name"
